...
Kid 4 has 1 candy and even if he or she receives all extra candies will only have 4
candies.
...
//another solution
// generally not recommended to use Math.max() with big arrays because it will fail
//here the constraints make it ok
